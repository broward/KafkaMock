...
public class EmbeddedKafkaCluster {
	...
	public EmbeddedKafkaCluster(String zkConnection) {
		this(zkConnection, new Properties(), 0);
	}

	public EmbeddedKafkaCluster(String zkConnection, Properties baseProperties, int brokerid) {
		this(zkConnection, baseProperties, Collections.singletonList(-1), brokerid);
	}

	public EmbeddedKafkaCluster(String zkConnection, Properties baseProperties,
			List<Integer> ports, int brokerid) {
	...
	public void startup() {
		for (int i = 0; i < ports.size(); i++) {
			...
			properties.setProperty("broker.id", String.valueOf(i + brokerid));
